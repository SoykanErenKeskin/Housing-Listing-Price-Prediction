"""Sticky training progress with heartbeat spinner (V14)."""
...
class TrainProgress:
    ...
    def start(self) -> None:
        ...
        self._thread = threading.Thread(target=self._heartbeat_loop, name="v14-progress", daemon=True)
        self._thread.start()
        self.render()
    ...
    def _status_text(self) -> str:
        ...
        return (
            f"V14 {spin} [{self._bar(pct)}] {pct:5.1f}% | "
