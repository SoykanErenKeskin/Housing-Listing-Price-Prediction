...
def build_early_arg_parser() -> Any:
    ...
    ap.add_argument("--run-satellite-ablation", action=argparse.BooleanOptionalAction, default=False)
    ap.add_argument("--run-spatial-diagnostic", action=argparse.BooleanOptionalAction, default=False)
