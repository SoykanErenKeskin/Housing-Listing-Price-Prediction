...
- R2: 0.481280798919443 | MAPE: 0.1083641874887162 | MAE: 4423.711172597294
- v12_delta: {}
- karamursel_sale_diff_pct: None
- direction_pass_rate: None
- warnings: ['global_guardrail_failed', 'basiskele_compressed', 'karamursel_insensitive']
...
{
  "sales_raw_rows": 997,
  "sales_after_base_clean_rows": 997,
  "sales_after_basic_filter_rows": 970,
  "sales_final_rows": 963,
  ...
  "rows_before_location_filter": 963,
  "rows_after_location_filter": 951,
  ...
  "removed_ratio_summary": {
    "min": 0.41326843726984347,
    "median": 1.1598636070538324,
...
## Feature reports
{
  "rental_features": {
    ...
    "rent_feature_level_counts": {
      "district_room": 917,
      "district": 23,
      "district_m2_group": 22,
      "county": 1
    }
  },
  "trend_features": {
    "trend_rows_used": 38,
    "trend_district_matched_rows": 963,
  ...
  "demographic_features": {
    ...
    "demo_rows": 488,
    "listing_rows": 951,
    "matched_listing_rows": 930,
    "match_rate": 0.9779179810725552,
    "county_matched_listing_rows": 930,
    "county_match_rate": 0.9779179810725552,
...
## Decision
{
  ...
  "r2": 0.481280798919443,
  "mape": 0.1083641874887162,
  "variance_ratio": 0.44883124906181665,
  "expensive_decile_bias": -10423.791542031546,
  "large_home_r2": 0.2832704267968037,
  "leakage_guard_pass": true,
  "coverage": {
    "extracted_raw_rate": 0.3379237288135593,
    "alias_hit_rate": 0.2870762711864407,
    "dict_hit_rate": 0.1504237288135593,
    "canonical_non_missing_rate": 0.3379237288135593,
    "n_rows": 944.0,
    "n_canonical_sites": 151.0,
    "foldsafe_encoded_site_count": 28.0,
    "top_expensive_underpredicted_site_missing_rate": 0.5217391304347826
  },
...
## Ensemble metrics
{
  "rows": 944,
  "r2": 0.481280798919443,
  "log_r2": 0.48650737667601573,
  "mape": 0.1083641874887162,
  "median_ape": 0.0870910261414666,
  "mae_tl_per_m2": 4423.711172597294,
  "median_ae_tl_per_m2": 3480.8195655947493,
  "model": "county_expert_segment_aware_ensemble_v16",
  "base_weights": {
    "extra_trees": 0.3364211206870465,
    "ridge": 0.33382143917735635,
    "gradient_boosting": 0.3297574401355972
  },
  "segment_weights": {
    "large_home": {
      "extra_trees": 0.5097508749947236,
      "random_forest": 0.49024912500527645
    },
    "mainstream_home": {
      "extra_trees": 0.5031095715946107,
      "gradient_boosting": 0.49689042840538944
    }
  },
  ...
  "karamursel_sale_diff_pct": -0.356082314378497,
  "basiskele_variance_ratio": 0.44883124906181665,
  ...
  "fast_mode": false,
  "training_rows_before_anomaly_filter": 951,
  "training_rows_after_anomaly_filter": 944,
  "excluded_anomaly_rows": 7,
  "exclude_anomalies_threshold": 25.0
}
