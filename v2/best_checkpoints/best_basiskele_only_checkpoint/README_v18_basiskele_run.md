...
**Pack copy** of the closed V18 run notes (curated under
`best_basiskele_only_checkpoint/`).
...
After layout migration, prefer `v2/source_versions/v18_basiskele/` and
repo-root `data/external/geo_context`.
