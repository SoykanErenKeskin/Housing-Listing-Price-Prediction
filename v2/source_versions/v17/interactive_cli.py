...
def apply_interactive_prompts(args: Any, argv: list[str] | None = None) -> Any:
    ...
    print("\n════════════════════════════════════════")
    print(" V17 etkileşimli ayar sihirbazı")
    ...
    if not cli_flag_provided(argv, "--karamursel-baseline-mode"):
        ...
        opts = [
            ChoiceOption("none", "none", "Kapalı (V17 default — V16 ablation'da finali geçmedi)."),
...
def build_early_arg_parser() -> Any:
    ...
    ap.add_argument("--location-feature-mode", choices=["none", "basic", "geo", "comparable", "full"], default="full")
