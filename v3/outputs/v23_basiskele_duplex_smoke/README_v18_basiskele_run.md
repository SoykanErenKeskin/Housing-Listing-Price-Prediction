...
- R2: 0.343982781751075 | MAPE: 0.10526616631926165 | MAE: 3905.3841336549126
- v12_delta: {}
...
{
  "sales_raw_rows": 400,
  "sales_after_base_clean_rows": 400,
  "sales_after_basic_filter_rows": 400,
  "sales_final_rows": 396,
  "sales_removed_basic_rows": 0,
  "sales_removed_iqr_rows": 4,
  "rentals_raw_rows": 300,
  "rentals_after_base_clean_rows": 300,
  "rentals_after_basic_filter_rows": 298,
  "rentals_final_rows": 294,
  "rentals_removed_basic_rows": 2,
  "rentals_removed_iqr_rows": 4,
  "location_outlier_filter_enabled": true,
  "rows_before_location_filter": 396,
  "rows_after_location_filter": 394,
  "rows_removed_location_filter": 2,
  "min_location_ratio": 0.5,
  "max_location_ratio": 1.9,
  "location_mad_threshold": 3.5,
  "location_min_group_size": 12,
  "removed_ratio_summary": {
    "min": 1.2260633202058926,
    "median": 1.4935114707524362,
    "max": 1.7609596212989798
  }
}
...
{
  "rental_features": {
    "rental_rows_used": 294,
    "global_rent_m2_median": 245.43,
    "global_rent_row_count": 294,
  ...
  "trend_features": {
    "trend_rows_used": 38,
    "trend_district_matched_rows": 396,
  ...
  "demographic_features": {
    ...
    "demo_rows": 488,
    "listing_rows": 394,
    "matched_listing_rows": 394,
    "match_rate": 1.0,
    "county_matched_listing_rows": 394,
...
## Decision
{
  ...
  "r2": 0.343982781751075,
  "mape": 0.10526616631926165,
  "variance_ratio": 0.3128527905410542,
  "expensive_decile_bias": -9687.553047795447,
  "large_home_r2": 0.26954016584832774,
  "leakage_guard_pass": true,
  "coverage": {
    "extracted_raw_rate": 0.24873096446700507,
    "alias_hit_rate": 0.23857868020304568,
    "dict_hit_rate": 0.08375634517766498,
    "canonical_non_missing_rate": 0.24873096446700507,
    "n_rows": 394.0,
    "n_canonical_sites": 59.0,
    "foldsafe_encoded_site_count": 7.0,
    "top_expensive_underpredicted_site_missing_rate": 0.375
  },
...
## Ensemble metrics
{
  "rows": 394,
  "r2": 0.343982781751075,
  "log_r2": 0.34836513083280984,
  "mape": 0.10526616631926165,
  "median_ape": 0.08539114503753743,
  "mae_tl_per_m2": 3905.3841336549126,
  "median_ae_tl_per_m2": 3015.9996796449377,
  "model": "county_expert_segment_aware_ensemble_v16",
  "base_weights": {
    "gradient_boosting": 0.33822143208998734,
    "extra_trees": 0.33557073458927345,
    "random_forest": 0.3262078333207392
  },
  "segment_weights": {
    "mainstream_home": {
      "extra_trees": 0.5054107990040055,
      "gradient_boosting": 0.4945892009959944
    }
  },
  ...
  "karamursel_sale_diff_pct": 0.1448627520965184,
  "basiskele_variance_ratio": 0.3128527905410542,
  ...
  "training_rows_before_anomaly_filter": 394,
  "training_rows_after_anomaly_filter": 394,
