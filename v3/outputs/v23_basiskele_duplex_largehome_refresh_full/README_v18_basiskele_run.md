# V23 Başiskele Duplex Refresh — Selected (new-data)

**Status:** Selected checkpoint for refreshed Başiskele inventory  
**Selected experiment:** `duplex_interactions`  
**Primary comparison:** `control_v21_on_new_data` (not old V21 R²=0.5059)  
**Lift:** Modest but consistent duplex-aware improvement (R² 0.4833→0.4918, MAPE 0.1048→0.1039).  
**Open:** expensive top-decile underprediction; garden duplex difficulty.  
See `reports/selection_decision_v23_new_data.json` and `reports/SELECTION_V23_NEW_DATA.md`.
...
- R2: 0.49181579342533 | MAPE: 0.10393495168766125 | MAE: 4069.465666470158
- v12_delta: {}
...
{
  "sales_raw_rows": 1825,
  "sales_after_base_clean_rows": 1825,
  "sales_after_basic_filter_rows": 1798,
  "sales_final_rows": 1786,
  "sales_removed_basic_rows": 27,
  "sales_removed_iqr_rows": 12,
  "rentals_raw_rows": 682,
  "rentals_after_base_clean_rows": 682,
  "rentals_after_basic_filter_rows": 656,
  "rentals_final_rows": 648,
  "rentals_removed_basic_rows": 26,
  "rentals_removed_iqr_rows": 8,
  "location_outlier_filter_enabled": true,
  "rows_before_location_filter": 1786,
  "rows_after_location_filter": 1758,
  "rows_removed_location_filter": 28,
  "min_location_ratio": 0.5,
  "max_location_ratio": 1.9,
  "location_mad_threshold": 3.5,
  "location_min_group_size": 12,
  "removed_ratio_summary": {
    "min": 0.4206969947225439,
    "median": 1.3680371318871376,
    "max": 1.9940936082844618
  }
}
...
{
  "rental_features": {
    "rental_rows_used": 648,
    "global_rent_m2_median": 250.0,
    "global_rent_row_count": 648,
    "rent_feature_level_counts": {
      "district_room": 1738,
      "district_m2_group": 26,
      "district": 19,
      "county": 3
    }
  },
  "trend_features": {
    "trend_rows_used": 38,
    "trend_district_matched_rows": 1786,
  ...
  "demographic_features": {
    ...
    "demo_rows": 488,
    "listing_rows": 1758,
    "matched_listing_rows": 1725,
    "match_rate": 0.9812286689419796,
    "county_matched_listing_rows": 1725,
    "county_match_rate": 0.9812286689419796,
...
## Decision
{
  ...
  "r2": 0.49181579342533,
  "mape": 0.10393495168766125,
  "variance_ratio": 0.47740226073477005,
  "expensive_decile_bias": -9416.72005912292,
  "large_home_r2": 0.354198287731171,
  "leakage_guard_pass": true,
  "coverage": {
    "extracted_raw_rate": 0.2977752424415288,
    "alias_hit_rate": 0.26012549914432403,
    "dict_hit_rate": 0.11409013120365089,
    "canonical_non_missing_rate": 0.2977752424415288,
    "n_rows": 1753.0,
    "n_canonical_sites": 215.0,
    "foldsafe_encoded_site_count": 53.0,
    "top_expensive_underpredicted_site_missing_rate": 0.5449101796407185
  },
...
## Ensemble metrics
{
  "rows": 1753,
  "r2": 0.49181579342533,
  "log_r2": 0.49751096600706934,
  "mape": 0.10393495168766125,
  "median_ape": 0.07996287442304903,
  "mae_tl_per_m2": 4069.465666470158,
  "median_ae_tl_per_m2": 3083.7376216980847,
  "model": "county_expert_segment_aware_ensemble_v16",
  "base_weights": {
    "extra_trees": 0.33603974537169096,
    "gradient_boosting": 0.333758108595442,
    "ridge": 0.33020214603286707
  },
  "segment_weights": {
    "large_home": {
      "extra_trees": 0.5008503233077817,
      "gradient_boosting": 0.49914967669221844
    },
    "mainstream_home": {
      "gradient_boosting": 0.500617435840494,
      "ridge": 0.499382564159506
    }
  },
  "segment_blend_weights": {
    "large_home": 0.25,
    "mainstream_home": 0.25
  },
  "county_weights": {},
  ...
  "karamursel_sale_diff_pct": 0.02244449181478606,
  "basiskele_variance_ratio": 0.47740226073477005,
  "site_project_encoding_leakage_guard": {
    ...
    "n_sites_encoded": 53,
    "global_mean": 38990.633354249854
  },
  ...
  "fast_mode": false,
  "training_rows_before_anomaly_filter": 1758,
  "training_rows_after_anomaly_filter": 1753,
  "excluded_anomaly_rows": 5,
  "exclude_anomalies_threshold": 25.0
}
