...
## Executive Summary
- **Promoted:** best Kocaeli global checkpoint (`full_v24`, `best_checkpoint=true`)
- overall: PROMOTED_KOCAELI_GLOBAL
- selected_attribute_mode: full
- demographics_mode: safe
- R2: 0.6523243261980677 | MAPE: 0.11762822096027113 | MAE: 4412.251071876958
- severe_bad_merge: 0 | possible_bad_merge: 12 (non-blocking manual review)
- Hierarchy: V24.1 = best Kocaeli global; V23 = best refreshed Başiskele-only; V22 = diagnostic no-lift
- v12_delta: {}
- karamursel_sale_diff_pct: None
- direction_pass_rate: None
- warnings: ['global_guardrail_failed', 'izmit_r2_soft_floor'] (soft; did not block promotion)
...
## Decision
{
  ...
  "expensive_decile_bias": -8595.524608059715,
  "large_home_r2": 0.5498665456711831,
  "leakage_guard_pass": true,
  "coverage": {
    "extracted_raw_rate": 0.3049347532623369,
    "alias_hit_rate": 0.2734363281835908,
    "dict_hit_rate": 0.030148492575371232,
    "canonical_non_missing_rate": 0.3047847607619619,
    "n_rows": 6667.0,
    "n_canonical_sites": 890.0,
    "foldsafe_encoded_site_count": 188.0,
    "top_expensive_underpredicted_site_missing_rate": 0.5102389078498294
  },
  "best_checkpoint": true,
  "selected_experiment": "full_v24",
  "severe_bad_merge": 0,
  "possible_bad_merge": 12,
  "note": "V24.1 full_v24 is the best Kocaeli global checkpoint. severe_bad_merge=0; possible_bad_merge=12 kept as non-blocking manual review candidates. V23 remains the best refreshed Başiskele-only checkpoint. V22 remains diagnostic no-lift. Site/project extraction is now validated globally after merge repair.",
  "selected_attribute_mode": "full",
...
## Ensemble metrics
{
  "rows": 6667,
  "r2": 0.6523243261980677,
  "log_r2": 0.6675848396055539,
  "mape": 0.11762822096027113,
  "median_ape": 0.09184965233749366,
  "mae_tl_per_m2": 4412.251071876958,
  "median_ae_tl_per_m2": 3347.4566468065714,
  "model": "county_expert_segment_aware_ensemble_v16",
  "base_weights": {
    "ridge": 0.3391553498448724,
    "extra_trees": 0.3351292057608741,
    "gradient_boosting": 0.32571544439425343
  },
  "segment_weights": {
    "large_home": {
      "ridge": 0.501911800926678,
      "extra_trees": 0.498088199073322
    },
    "compact_home": {
      "gradient_boosting": 0.5059475114311952,
      "ridge": 0.4940524885688048
    },
    "old_building": {
      "gradient_boosting": 0.5002083587139965,
      "extra_trees": 0.4997916412860035
    },
    "mainstream_home": {
      "ridge": 0.5007295101249684,
      "extra_trees": 0.4992704898750316
    }
  },
  ...
  "direction_pass_rate": 0.96875,
  "karamursel_sale_diff_pct": 0.5785693053918447,
  "basiskele_variance_ratio": 0.4717577441458082,
