...
- R2: 0.5059022056902565 | MAPE: 0.10552770010188577 | MAE: 4345.0762190831265
- v12_delta: {}
...
## Decision
{
  ...
  "r2": 0.5059022056902565,
  "mape": 0.10552770010188577,
  "variance_ratio": 0.45900658007420714,
  "expensive_decile_bias": -10158.761516544975,
  "large_home_r2": 0.308812974100272,
  "leakage_guard_pass": true,
  "coverage": {
    "extracted_raw_rate": 0.34276387377584333,
    "alias_hit_rate": 0.29053318824809576,
    "dict_hit_rate": 0.15451577801958652,
    "canonical_non_missing_rate": 0.34276387377584333,
    "n_rows": 919.0,
    "n_canonical_sites": 149.0,
    "foldsafe_encoded_site_count": 28.0,
    "top_expensive_underpredicted_site_missing_rate": 0.5517241379310345
  },
...
## Ensemble metrics
{
  "rows": 919,
  "r2": 0.5059022056902565,
  "log_r2": 0.5123889852648608,
  "mape": 0.10552770010188577,
  "median_ape": 0.08670616494684916,
  "mae_tl_per_m2": 4345.0762190831265,
  "median_ae_tl_per_m2": 3425.273318637577,
  "model": "county_expert_segment_aware_ensemble_v16",
  "base_weights": {
    "gradient_boosting": 0.33522290012419087,
    "extra_trees": 0.3349571427270393,
    "ridge": 0.3298199571487698
  },
  "segment_weights": {
    "large_home": {
      "extra_trees": 0.5058464264194039,
      "random_forest": 0.49415357358059603
    },
    "mainstream_home": {
      "ridge": 0.5037276123835127,
      "gradient_boosting": 0.49627238761648734
    }
  },
  ...
  "karamursel_sale_diff_pct": 0.007570456157753484,
  "basiskele_variance_ratio": 0.45900658007420714,
