...
- R2: 0.3875755987097771 | MAPE: 0.11755617246141382 | MAE: 4884.999563434606
- v12_delta: {}
- karamursel_sale_diff_pct: None
- direction_pass_rate: None
- warnings: ['global_guardrail_failed', 'basiskele_no_r2_lift', 'basiskele_compressed', 'karamursel_insensitive']
...
## Decision
{
  "selected_premium_feature_mode": "full",
  "selected_site_project_encoding": "frequency",
  "r2": 0.3875755987097771,
  "mape": 0.11755617246141382,
  "variance_ratio": 0.44909211626018986,
  "expensive_decile_bias": -9454.490771622819,
  "large_home_r2": 0.32127252544904183,
...
## Ensemble metrics
{
  "rows": 283,
  "r2": 0.3875755987097771,
  "log_r2": 0.40597173370839035,
  "mape": 0.11755617246141382,
  "median_ape": 0.09189305970932787,
  "mae_tl_per_m2": 4884.999563434606,
  "median_ae_tl_per_m2": 3629.4171007373443,
  "model": "county_expert_segment_aware_ensemble_v16",
  "base_weights": {
    "ridge": 0.340918690146977,
    "extra_trees": 0.33166383085265744,
    "gradient_boosting": 0.3274174790003656
  },
  "segment_weights": {
    "mainstream_home": {
      "ridge": 0.5160529120286448,
      "gradient_boosting": 0.4839470879713551
    }
  },
  ...
  "karamursel_sale_diff_pct": -0.10895132167339126,
  "basiskele_variance_ratio": 0.44909211626018986,
