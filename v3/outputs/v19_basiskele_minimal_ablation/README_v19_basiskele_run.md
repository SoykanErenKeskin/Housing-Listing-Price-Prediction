...
## V19 Minimal Ablation Decision

V19 tested OOF-safe calibration and no-ridge ensemble variants on Başiskele-only data.

Experiments:
- control_none_balanced
- linear_balanced
- isotonic_balanced
- control_none_no_ridge
- linear_no_ridge
- isotonic_no_ridge
...
Reason:
No calibration/no_ridge candidate improved R2 over control while keeping MAPE within guardrail.

Key finding:
Isotonic calibration increased variance ratio but reduced R2/MAPE quality. Therefore calibration is rejected as final predictor adjustment.

Decision:
V19 does not replace V18 best checkpoint.
Keep V18 Başiskele-only geo control / comparable none as best known Başiskele checkpoint.
Use V19 as diagnostic evidence that blind/monotonic calibration and no-ridge are not enough to solve Başiskele mean-pulling.

Status: **diagnostic / rejected_for_final_model** (unless a future `direct_price` / `hybrid` arm beats V18).
...
- R2: 0.4707686238439077 | MAPE: 0.10965835353426871 | MAE: 4522.485094269292
- v12_delta: {}
...
- selected_experiment: control_none_balanced
- calibration_mode: none | ensemble_profile: balanced | target_profile: residual_log
...
## Decision
{
  ...
  "direction_pass_rate": 1.0,
  "karamursel_sale_diff_pct": 0.31074221507712513,
  "basiskele_r2": 0.4707686238439077,
  "basiskele_variance_ratio": 0.42857077786913483,
  "basiskele_lift": {
    "r2": 0.4707686238439077,
    "r2_delta_vs_v16": 0.03056862384390774,
    "r2_delta_vs_v15": 0.017368623843907693,
    "variance_ratio": 0.42857077786913483,
    "variance_delta_vs_v16": -0.01462922213086515
  },
  "golcuk_r2": NaN,
  "izmit_r2": NaN,
  "karamursel_r2": NaN,
  ...
  "top_risks": [],
  "top_opportunities": [
    "Başiskele R2 0.4708 (vs V16 0.4402)"
  ],
  "v14_reference": {
    "r2": 0.6787,
    "mape": 0.129,
  ...
  "v16_delta": {
    "r2": -0.2095313761560923,
    "mape": -0.01884164646573129,
    "basiskele_r2": 0.03056862384390774,
    "basiskele_variance_ratio": -0.01462922213086515,
    "karamursel_r2": NaN,
    "golcuk_r2": NaN,
    "izmit_r2": NaN
  },
  "v15_delta": {
    "r2": -0.20913137615609223,
    "mape": -0.01934164646573129,
    "basiskele_r2": 0.017368623843907693,
    "karamursel_r2": NaN
  },
  "selected_attribute_mode": "full",
...
## Ensemble metrics
{
  "rows": 919,
  "r2": 0.4707686238439077,
  "log_r2": 0.47863385233351363,
  "mape": 0.10965835353426871,
  "median_ape": 0.0893591954998395,
  "mae_tl_per_m2": 4522.485094269292,
  "median_ae_tl_per_m2": 3503.072187998616,
  ...
  "segment_weights": {
    "large_home": {
      "extra_trees": 0.5041334750689048,
      "random_forest": 0.4958665249310951
    },
    "mainstream_home": {
